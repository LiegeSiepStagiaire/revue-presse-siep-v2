...
def get_articles(rss_url, keyword, sources, accept_all=True):
    ...
    (
        any(src in link for src in ['euronews.com', 'politico.eu', 'dw.com', 'deutschlandfunk.de', 'euractiv.com', 'bruegel.org']) and (
            any(kw.lower() in entry.title.lower() for kw in ['emploi', 'recherche d’emploi', 'législation du travail', 'contrat', 'job étudiant', 'insertion socio-professionnelle', 'CISP', 'année citoyenne', 'volontariat', 'rédaction de CV', 'études', 'enseignement secondaire', 'enseignement supérieur', 'enseignement qualifiant', 'décret', 'structure scolaire', 'organisation des études', 'établissement scolaire', 'droit scolaire', 'exclusion scolaire', 'recours scolaire', 'accès aux études', 'coût des études', 'bourse d’étude', 'prêt d’étude', 'CPMS', 'école de devoirs', 'remédiation', 'méthode de travail', 'aide à la réussite', 'tutorat', 'DASPA', 'certification', 'choix d’études', 'année préparatoire', 'journée portes ouvertes', 'passerelle', 'valorisation des acquis (VAE)', 'formation en alternance', 'CEFA', 'IFAPME', 'EFP', 'jury', 'enseignement à distance', 'horaire réduit', 'alphabétisation', 'promotion sociale', 'formation demandeur d’emploi', 'FOREM', 'ACTIRIS', 'centre de compétence', 'validation des compétences', 'chômage', 'mutuelle', 'aide sociale', 'revenu d’intégration sociale (RIS)', 'allocations familiales', 'financement des études', 'aide à la jeunesse', 'sexualité', 'planning familial', 'égalité des genres', 'animation GDBD', 'charte égalité', 'santé', 'consommation', 'harcèlement', 'sensibilisation', 'logement intergénérationnel', 'kot étudiant', 'contrat de bail', 'transport', 'sport', 'stage vacances', 'formation animateur', 'centre d’hébergement', 'centre de rencontre', 'projet international', 'séjour linguistique', 'stage à l’étranger', 'apprendre les langues', 'bourse internationale', 'test de langue', 'niveau CECRL', 'mobilité européenne', 'citoyenneté', 'droits', 'devoirs', 'engagement', 'implication politique', 'démocratie', 'droit à l’image', 'réseaux sociaux', 'nationalité', 'institutions belges', 'institutions européennes', 'droits humains', 'partis politiques', 'participation des jeunes', 'mouvements philosophiques', 'police', 'justice', 'groupe de pression', 'orientation métier', 'projet de vie', 'connaissance de soi', 'information métier', 'exploration', 'rencontre professionnelle']) or
            any(kw.lower() in entry.get("summary", "").lower() for kw in ['emploi', 'recherche d’emploi', 'législation du travail', 'contrat', 'job étudiant', 'insertion socio-professionnelle', 'CISP', 'année citoyenne', 'volontariat', 'rédaction de CV', 'études', 'enseignement secondaire', 'enseignement supérieur', 'enseignement qualifiant', 'décret', 'structure scolaire', 'organisation des études', 'établissement scolaire', 'droit scolaire', 'exclusion scolaire', 'recours scolaire', 'accès aux études', 'coût des études', 'bourse d’étude', 'prêt d’étude', 'CPMS', 'école de devoirs', 'remédiation', 'méthode de travail', 'aide à la réussite', 'tutorat', 'DASPA', 'certification', 'choix d’études', 'année préparatoire', 'journée portes ouvertes', 'passerelle', 'valorisation des acquis (VAE)', 'formation en alternance', 'CEFA', 'IFAPME', 'EFP', 'jury', 'enseignement à distance', 'horaire réduit', 'alphabétisation', 'promotion sociale', 'formation demandeur d’emploi', 'FOREM', 'ACTIRIS', 'centre de compétence', 'validation des compétences', 'chômage', 'mutuelle', 'aide sociale', 'revenu d’intégration sociale (RIS)', 'allocations familiales', 'financement des études', 'aide à la jeunesse', 'sexualité', 'planning familial', 'égalité des genres', 'animation GDBD', 'charte égalité', 'santé', 'consommation', 'harcèlement', 'sensibilisation', 'logement intergénérationnel', 'kot étudiant', 'contrat de bail', 'transport', 'sport', 'stage vacances', 'formation animateur', 'centre d’hébergement', 'centre de rencontre', 'projet international', 'séjour linguistique', 'stage à l’étranger', 'apprendre les langues', 'bourse internationale', 'test de langue', 'niveau CECRL', 'mobilité européenne', 'citoyenneté', 'droits', 'devoirs', 'engagement', 'implication politique', 'démocratie', 'droit à l’image', 'réseaux sociaux', 'nationalité', 'institutions belges', 'institutions européennes', 'droits humains', 'partis politiques', 'participation des jeunes', 'mouvements philosophiques', 'police', 'justice', 'groupe de pression', 'orientation métier', 'projet de vie', 'connaissance de soi', 'information métier', 'exploration', 'rencontre professionnelle'])
        )
    )
):
...
accept_all = True  # Forcé, filtré avec équilibre belge/UE
